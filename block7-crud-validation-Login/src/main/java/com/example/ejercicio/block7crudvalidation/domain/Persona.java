...
public class Persona {
    ...
    public void validarPersona() throws UnprocessableEntityException {
        ...
        if (usuario.length() < 6) {
            throw new UnprocessableEntityException("El nombre debe contener entre 6 y 10 caracteres");
        }
        if (usuario.length() > 10) {
            throw new UnprocessableEntityException("Longitud de usuario no puede ser mayor a 10 carácteres");
        }
        if (password == null) {
            throw new UnprocessableEntityException("Debes introducir una contraseña");
        }
        if (name == null) {
            throw new UnprocessableEntityException("Debes introducir un nombre");
        }
        if (company_email == null) {
            throw new UnprocessableEntityException("Debes introducir un mail de compañía");
        }
        if (personal_email == null) {
            throw new UnprocessableEntityException("Debes introducir un mail personal");
        }
        if (city == null) {
            throw new UnprocessableEntityException("Debes introducir una ciudad");
        }
        if (active == null) {
            throw new UnprocessableEntityException("Debes introducir un valor");
        }
        if (created_date == null) {
            throw new UnprocessableEntityException("Debes introducir una fecha");
        }
        if (admin == null) {
            throw new UnprocessableEntityException("Debes introducir un valor");
        }
